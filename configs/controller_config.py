...
CONTROLLER_CONFIG = {
    ...
    'bellman': {
        'N_R': 120,              # Grid points for remaining reliability R
        'N_eps': 30,             # Grid points per noise dimension
        'eps_range': 4.0,        # Noise range: [-eps_range, +eps_range]
        'R_min': -0.1,           # Lower bound of R grid
        'M_actions': 120,        # Number of action candidates per process
        'K_mc': 2000,            # MC samples for non-terminal steps
