...
- use_dense_connections: Enable dense connections to mitigate vanishing gradients (default: True)
                        When enabled, each policy receives as additional input the actions
                        generated by ALL previous policies in the chain:
                        ...
                        Set to False to revert to the original behavior (only previous process output)
...
CONTROLLER_CONFIG = {
    ...
    'policy_generator': {
        ...
        # Dense Connections: passa le azioni di TUTTE le policy precedenti
        # Policy₂.input = [o₂, scenario_emb, a₂]  # + azione di Policy₁
        # Policy₃.input = [o₃, scenario_emb, a₂, a₃]  # + azioni di Policy₁ e Policy₂
        # Questo crea percorsi di gradiente più corti: ∂L/∂a₄ · ∂a₄/∂a₂ · ∂a₂/∂θ₁
        'use_dense_connections': True,  # Enable dense connections for vanishing gradient mitigation
    },
