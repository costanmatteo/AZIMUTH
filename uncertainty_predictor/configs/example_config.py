...
CONFIG = {
    ...
    'data': {
        # Data source options:
        # 1. Use SCM-generated data: 'scm/data/scm_dataset.csv'
        # 2. Use external CSV: 'path/to/your/data.csv'
        # 3. Set to 'auto' to auto-generate if file doesn't exist
        'csv_path': 'auto',  # 'auto', 'scm/data/scm_dataset.csv', or path to external CSV
